module Stock
  class Stock
    ...
    def _good_price(good_model)
      ...
      good_stave      = "SEL3"  if  good_up1_up2    &&  good_mup_boll # 3. SELL - up2 -> up1
      good_stave      = "BUY4"  if  good_dn1_dn2    &&  good_mup_boll # 4. BUY  - boll up ?
      good_stave      = "BUY5"  if  good_up1_trend  &&  good_mup_boll # 5. BUY  - more - positive ?
      good_stave      = "SEL6"  if  good_up1_up2    &&  good_mup_boll # 6. SELL - some
